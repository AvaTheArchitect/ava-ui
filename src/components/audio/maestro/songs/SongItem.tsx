...
import { SongItem, Playlist, getDifficultyLabel, getDifficultyColor } from '@/lib/song-data';
          ...
          `}
                >
                    <svg
                        ...
                        stroke="currentColor"
                        strokeWidth={song.isFavorite ? "0" : "2"}
                    >
                                    ...
                                    playlists.map(playlist => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    handlePlaylistAction(inPlaylist ? 'remove' : 'add', playlist.id);
                                                }}
