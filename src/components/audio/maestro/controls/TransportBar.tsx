 ...
 * ✅ Full-cell hover behavior locked with group/group-hover.
 * ✅ Hover color aligned to cyan-300 across icon, label, and empty cell hover regions.
 * ✅ Active/open/on states remain green-400.
 * ✅ Label typography polished:
 *    - text-[10px]
 *    - font-medium
 *    - tracking-[0.3px]
 *    - leading-[14px]
 * ✅ Speed, Loop, Export delegated child icons aligned with TransportBar tray color system.
 * ✅ Stray JSX text-node regression removed; TransportBar height restored to 74px.
 *
    ...
    <div className="fixed bottom-0 left-0 right-0 !z-[9999] bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 border-t border-purple-500/30 shadow-2xl backdrop-blur-sm">
      <div className="w-full h-[74px] flex items-center">
        ...
        >
          ...
          <div
            ref={speedPanelRef}
            className="group flex-none w-[64px] [@media(max-width:711px)]:w-[60px] h-[74px] relative flex flex-col items-center justify-center gap-0.5"
          >
            <SpeedControl
              api={api}
          ...
          {/* Loop */}
          <div className="group flex-none w-[51px] [@media(min-width:712px)_and_(max-width:999px)]:w-[44px] [@media(max-width:711px)]:w-[34px] h-[74px] relative flex flex-col items-center justify-center gap-0.5">
              ...
              <div className="flex-none w-[51px] [@media(min-width:712px)_and_(max-width:999px)]:w-[44px] [@media(max-width:711px)]:w-[34px] h-[74px] relative">
                ...
                >
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24"
                    className={`transition-colors ${isSoloed ? 'text-green-400' : 'text-blue-300 group-hover:text-cyan-300'}`}
                    fill="currentColor"
                  >
            ...
            return (
              <div className="flex-none w-[51px] [@media(min-width:712px)_and_(max-width:999px)]:w-[44px] [@media(max-width:711px)]:w-[34px] h-[74px] relative">
                ...
                >
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24"
                    className={`transition-colors ${isMuted ? 'text-green-400' : 'text-blue-300 group-hover:text-cyan-300'}`}
                    fill="currentColor"
                  >
          ...
          <div className="flex-none w-[51px] [@media(min-width:712px)_and_(max-width:999px)]:w-[44px] [@media(max-width:711px)]:w-[34px] h-[74px] relative" ref={countInPanelRef}>
            ...
            >
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                className={`transition-colors ${isCountInEnabled ? 'text-green-400' : 'text-blue-300 group-hover:text-cyan-300'}`}
              >
          ...
          <div className="flex-none w-[68px] [@media(min-width:712px)_and_(max-width:999px)]:w-[44px] [@media(max-width:711px)]:w-[34px] h-[74px] relative" ref={metronomePanelRef}>
            ...
            >
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                className={`transition-colors ${isMetronomeEnabled && isSynthMode ? 'text-green-400' : 'text-blue-300 group-hover:text-cyan-300'}`}
              >
          ...
          {/* Export */}
          <div ref={exportPanelRef} className="group flex-none w-[51px] [@media(min-width:712px)_and_(max-width:999px)]:w-[44px] [@media(max-width:711px)]:w-[34px] h-[74px] relative flex flex-col items-center justify-center gap-0.5">
            <ExportPanel
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="group mx-auto w-[51px] [@media(min-width:712px)_and_(max-width:999px)]:w-[44px] [@media(max-width:711px)]:w-[34px] h-full p-0 flex flex-col items-center justify-center gap-0.5 transition-all duration-200 hover:brightness-125"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                className={`transition-colors ${isMoreMenuOpen ? 'text-green-400' : 'text-blue-300 group-hover:text-cyan-300'}`}
              >
          ...
          <div className="flex-none w-[51px] [@media(min-width:712px)_and_(max-width:999px)]:w-[44px] [@media(max-width:711px)]:w-[34px] h-[74px] flex flex-col items-center justify-center gap-0.5">
            ...
            >
              ...
              <svg width="24" height="24" viewBox="0 0 24 24"
                className="transition-colors text-blue-300 group-hover:text-cyan-300" fill="currentColor"
              >
