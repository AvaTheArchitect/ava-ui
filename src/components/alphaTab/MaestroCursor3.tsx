...
// are visual-only artwork constants — they extend the drawn shape above/below the beat
// box via SVG overflow:visible; they do not feed _applyTransform's x/y/h, which stay
// exactly vb.y/vb.h-derived, unchanged from the prior bar shape.
