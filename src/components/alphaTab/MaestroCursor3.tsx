...
// only. Cursor3 (dormant, MAESTRO_USE_CURSOR3=false) stays mapped to the same legacy
// teal tokens as Cursor2, not the purple --maestro-cursor-* set, so it can't silently
// drift onto a different color family than its active sibling.
