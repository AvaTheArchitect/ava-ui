 ...
 *
 * 🆕 Difficulty scale corrected to align with DB types.ts:
...
export const SONGS: SongItem[] = [
  {
    ...
    album: "No More Tears",
    fileUrl: `${BASE_PATH}/ozzy-no-more-tears/no-more-tears.gp3`,
  ...
  },
  {
    ...
    artist: "Cinderella",
    album: "Night Songs",
    fileUrl: `${BASE_PATH}/cinderella-hot-and-bothered/hot-and-bothered.gp5`,
    difficulty: 1, // Beginner
    isFavorite: false,

    youtubeVideoId: "uDdATtV125Y",
    youtubeVariants: {
      main: "uDdATtV125Y",
    },
    videoStartOffset: 0,
  },
  {
    ...
    fileUrl: `${BASE_PATH}/poison-i-wont-forget-you/i-wont-forget-you.gp4`,
    difficulty: 1, // Beginner
    isFavorite: false,

    youtubeVideoId: "RthGYtQ_dxA",
    youtubeVariants: {
      main: "RthGYtQ_dxA",
    },
    videoStartOffset: 0,
  },
  {
    ...
    fileUrl: `${BASE_PATH}/poison-so-tell-me-why/so-tell-me-why.gp5`,
    difficulty: 1, // Beginner
    isFavorite: false,

    youtubeVideoId: "biNYufJRp1A",
    youtubeVariants: {
      main: "biNYufJRp1A",
    },
    videoStartOffset: 0,
  },
  {
    ...
    album: "Texas Flood",
    fileUrl: `${BASE_PATH}/srv-pride-and-joy/pride-and-joy.gp5`,
  ...
  },
  {
    ...
    artist: "Van Halen",
    album: "Van Halen",
    fileUrl: `${BASE_PATH}/vanhalen-aint-talking-bout-love/aint-talkin-bout-love.gpx`,
    difficulty: 2, // Intermediate
    isFavorite: false,

    youtubeVideoId: "qtwBFz6lfrY",
    youtubeVariants: {
      main: "qtwBFz6lfrY",
    },
    videoStartOffset: 0,
  },
  {
    ...
    artist: "Warrant",
    album: "Cherry Pie",
    fileUrl: `${BASE_PATH}/warrant-uncle-toms-cabin/uncle-toms-cabin.gp5`,
    difficulty: 2, // Intermediate
    isFavorite: false,
...
export const DEFAULT_PLAYLISTS: ClientPlaylist[] = [
  {
    id: "playlist-1",
    name: "My Shred List",
    songIds: ["ozzy-no-more-tears", "srv-pride-and-joy"],
    createdAt: Date.now(),
  },
  {
    id: "playlist-2",
