...
**Generated for AI Consumption:** 8/11/2025, 11:44:20 AM
...
└── Maestro-AI Ecosystem
    ├── 🟣 Cipher Engine (123 routes, 120 working)
    │   ├── ⚙️ Config (10) [8 items]
    │   │   ├── 📁 .vscode (1 files)
    │   │   │   └── settings.json ✅
    ...
    │               ├── LivePreview.tsx ✅
    │               └── RenderPreview.tsx ✅
    ├── 🟦 Maestro AI (294 routes, 290 working)
    │   ├── 🧠 Brain (1) [1 items]
    │   │   └── MaestroBrain.ts ✅
    │   ├── 🔌 Api (1) [1 items]
    │   │   └── api-backend ✅
