...
**Generated for AI Consumption:** 8/17/2025, 4:00:14 PM
...
└── Maestro-AI Ecosystem
    ├── 🟣 Cipher Engine (201 routes, 196 working)
    │   ├── ⚙️ Config (10) [8 items]
    │   │   ├── 📁 .vscode (1 files)
    │   │   │   └── settings.json ✅
    ...
    │   ├── 📦 Source Files (140, showing 100) [1 items]
    ...
    │               ├── LivePreview.tsx ✅
    │               └── RenderPreview.tsx ✅
    ├── 🟦 Maestro AI (323 routes, 319 working)
    │   ├── 🧠 Brain (1) [1 items]
    │   │   └── MaestroBrain.ts ✅
    │   ├── 🔌 Api (1) [1 items]
    │   │   └── api-backend ✅
